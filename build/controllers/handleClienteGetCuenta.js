...
exports.handleClienteGetCuenta = void 0;
const leerTokenFromHeader_1 = require("../helpers/leerTokenFromHeader");
const Usuario_1 = require("../models/Usuario");
const handleClienteGetCuenta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const oCliente = oUsuario && (yield oUsuario.$get('oCliente'));
        res.status(200).json({
            ok: true,
...
exports.handleClienteGetCuenta = handleClienteGetCuenta;
